...
- [ ] Explain what a token is used for.
 ...
 Token is a string of cryptic text, stored in local storage to determine the service permissions for the user.

- [ ] What steps can you take in your web apps to keep your data secure?

Use Logins and Protected Private Route.

- [ ] Describe how web servers work.

A web server is store, process and deliver web pages to the clients.
